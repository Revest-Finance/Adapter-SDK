 ...
 */
contract jGLPAdapter is PermissionedAdapter, ERC4626 {
    ...
    constructor(ERC20 _asset, address _adapter, address _router, address _vault, address _feeHelper, 
    address _whitelist, address _GVRT, address _dust_wallet) ERC4626(_asset, "jGLP 4626 Adapter", "jGLP_RSN8") {
        adapter = _adapter;
        router = _router;
        vault = _vault;
