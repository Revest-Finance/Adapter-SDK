...
contract GmdBfrAdapter is ERC4626 {
    ...
    constructor(address _asset, address _vault, address _gmdToken, uint _pid) 
    ERC4626(ERC20(_asset), "GMD BFR 4626 Adapter", "GMD-BFR-4626") {
