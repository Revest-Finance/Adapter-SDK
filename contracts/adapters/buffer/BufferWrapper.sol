...
import {IBufferBinaryPool} from "../../interfaces/adapters/IBufferBinaryPool.sol";
import {PermissionedAdapter} from "../base/PermissionedAdapter.sol";
 ...
 */
contract BufferWrapper is ERC4626, PermissionedAdapter{
  ...
  //////////////////////////////////////////////////////////////*/
   ...
   //////////////////////////////////////////////////////////////*/
    ...
    function withdraw(uint256 assets, address receiver, address owner) public virtual override onlyResonateWallets returns (uint256 shares) {
        shares = super.withdraw(assets, receiver, owner);
    }

    function redeem(uint256 shares, address receiver, address owner) public virtual override onlyResonateWallets returns (uint256 assets) {
